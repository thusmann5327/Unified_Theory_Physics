...
Reference documentation for the Husmann Decomposition framework.
...
- **Proof 1**: Trace map derivation of the lattice form — NEGATIVE (algebraic barrier)
- **Proof 3**: Ωb = e^{-3} derivation — conditional on phenomenological e^{-1} step
- **Proof 5**: Global consistency cross-validation — in progress

See [`/tools/microtubules.md`](/tools/microtubules.md) for the full proof scorecard.
